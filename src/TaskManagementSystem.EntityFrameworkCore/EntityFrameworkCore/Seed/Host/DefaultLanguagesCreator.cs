...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = TaskManagementSystemConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(TaskManagementSystemDbContext context)
    {
        _context = context;
    }

...
public abstract class TaskManagementSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static TaskManagementSystemWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(TaskManagementSystemWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<TaskManagementSystemDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<TaskManagementSystemDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<TaskManagementSystemDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<TaskManagementSystemDbContext, Task<T>> func)
    {
        T result;
